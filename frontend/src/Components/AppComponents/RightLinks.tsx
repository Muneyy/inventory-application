        ...
        <>
            <Flex flexDirection="column" alignItems={"flex-start"} gap="5px" position={"sticky"} top={"80px"} w={"100%"} h={"100%"}>
                ...
                <RouteLink to='/login' style={{ textDecoration: 'none' }}>
                    <Button mb={10} size="sm" rightIcon={<ArrowForwardIcon />} variant="outline" borderRadius={"3xl"} colorScheme="teal">
                                                    Log in
                    </Button>
                </RouteLink>
                <RouteLink to="/createCollection">
                    <Button borderRadius="3xl" size="sm" rightIcon={<ArrowForwardIcon />} variant="outline" colorScheme="teal">
                            Collection
                    </Button>
                </RouteLink>
